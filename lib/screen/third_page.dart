...
class CartScreen extends ConsumerWidget{
  ...
  return  Scaffold(
    ...
    appBar: AppBar(
      ...
      title: Text('Cart',style: GoogleFonts.aboreto(fontSize: 25),),
      centerTitle: true,
      actions: [
        Center(
          child:
      ...
      child: Column(
        children: [
                  ...
                  if(snapshot.data!.isEmpty){
                    return Align(
                      ...
                      child: Column(
                        children: [
                          Image(
                            image: AssetImage('emt_pic/empty_cart.png'),
                          ),
                          SizedBox(height: 20,),
                          Text("!! .. Your cart is empty .. !!" ,style: GoogleFonts.aboreto(fontSize: 32),),
                          SizedBox(height: 20,),
                          Text('Explore products and shop your\nfavourite items' ,
                              textAlign: TextAlign.center ,style: GoogleFonts.aboreto(fontSize: 20))
          ...
          Visibility(
            ...
            child: Column(
              children: [
                ReusableWidget(title: 'QTY Total', value: r'$'+c.getTotalPrice().toStringAsFixed(2),),
                ReusableWidget(title: 'Discout 10%', value: r'$'+'40',),
